...
from ...models.engineering_extract_request import EngineeringExtractRequest
...
def _get_kwargs(
    *,
    body: EngineeringExtractRequest,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 202:
        response_202 = EngineeringExtractResponse.from_dict(response.json())

...
def _get_kwargs(
    *,
    body: DeepResearchRequestWithMode | QuerySearchRequest | UniversalSearchRequestWithMode | WebSearchRequestWithMode,
) -> dict[str, Any]:
    ...
    if isinstance(body, QuerySearchRequest):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, WebSearchRequestWithMode):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, DeepResearchRequestWithMode):
        _kwargs["json"] = body.to_dict()
    else:
        _kwargs["json"] = body.to_dict()
...
def sync_detailed(
    *,
    ...
    Args:
        body (DeepResearchRequestWithMode | QuerySearchRequest | UniversalSearchRequestWithMode |

...
from ...models.bootstrap_key_request import BootstrapKeyRequest
from ...models.bootstrap_key_response import BootstrapKeyResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = BootstrapKeyResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        BootstrapKeyResponse | HTTPValidationError
    """

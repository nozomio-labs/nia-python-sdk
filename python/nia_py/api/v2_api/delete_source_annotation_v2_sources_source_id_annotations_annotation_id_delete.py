...
from ...models.delete_source_annotation_v2_sources_source_id_annotations_annotation_id_delete_type_type_0 import (
...
def _get_kwargs(
    ...
    annotation_id: str,
    *,
    type_: DeleteSourceAnnotationV2SourcesSourceIdAnnotationsAnnotationIdDeleteTypeType0 | None | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(type_, Unset):
        json_type_ = UNSET
    elif isinstance(type_, DeleteSourceAnnotationV2SourcesSourceIdAnnotationsAnnotationIdDeleteTypeType0):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        source_id (str):
        annotation_id (str):
        type_ (DeleteSourceAnnotationV2SourcesSourceIdAnnotationsAnnotationIdDeleteTypeType0 |
            None | Unset): Source type hint

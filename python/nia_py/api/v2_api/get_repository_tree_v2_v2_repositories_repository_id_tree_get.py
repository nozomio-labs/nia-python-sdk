...
from ...models.repository_tree_response import RepositoryTreeResponse
...
) -> HTTPValidationError | RepositoryTreeResponse | None:
    if response.status_code == 200:
        response_200 = RepositoryTreeResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | RepositoryTreeResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        repository_id (str):
        branch (None | str | Unset): Branch to get tree for
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | RepositoryTreeResponse
    """

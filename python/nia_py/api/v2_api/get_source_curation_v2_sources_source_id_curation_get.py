...
from ...models.get_source_curation_v2_sources_source_id_curation_get_type_type_0 import (
...
def _get_kwargs(
    source_id: str,
    *,
    type_: GetSourceCurationV2SourcesSourceIdCurationGetTypeType0 | None | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(type_, Unset):
        json_type_ = UNSET
    elif isinstance(type_, GetSourceCurationV2SourcesSourceIdCurationGetTypeType0):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        source_id (str):
        type_ (GetSourceCurationV2SourcesSourceIdCurationGetTypeType0 | None | Unset): Source type
            hint

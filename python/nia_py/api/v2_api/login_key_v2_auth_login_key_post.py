...
from ...models.login_key_request import LoginKeyRequest
from ...models.login_key_response import LoginKeyResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LoginKeyResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | LoginKeyResponse
    """

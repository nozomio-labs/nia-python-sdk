...
if TYPE_CHECKING:
    from ..models.universal_search_request_with_mode_boost_source_types import (
        UniversalSearchRequestWithModeBoostSourceTypes,
    )


T = TypeVar("T", bound="UniversalSearchRequestWithMode")


@_attrs_define
class UniversalSearchRequestWithMode:
    """
    Attributes:
        ...
        boost_source_types (UniversalSearchRequestWithModeBoostSourceTypes | Unset): Source type boosts (override to
            customize or set {} to disable)
        ...
        expand_symbols (bool | Unset): Extract function/class names from results and search for usages (cAST-inspired)
            Default: False.
        mode (Literal['universal'] | Unset): Search mode discriminator Default: 'universal'.
    """
    ...
    boost_source_types: UniversalSearchRequestWithModeBoostSourceTypes | Unset = UNSET
    ...
    mode: Literal["universal"] | Unset = "universal"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        boost_source_types: UniversalSearchRequestWithModeBoostSourceTypes | Unset
        if isinstance(_boost_source_types, Unset):
            boost_source_types = UNSET
        else:
            boost_source_types = UniversalSearchRequestWithModeBoostSourceTypes.from_dict(_boost_source_types)
        ...
        mode = cast(Literal["universal"] | Unset, d.pop("mode", UNSET))
        if mode != "universal" and not isinstance(mode, Unset):
            raise ValueError(f"mode must match const 'universal', got '{mode}'")

        universal_search_request_with_mode = cls(
            query=query,
            top_k=top_k,
        ...
        universal_search_request_with_mode.additional_properties = d
        return universal_search_request_with_mode

...
T = TypeVar("T", bound="WebSearchRequestWithMode")


@_attrs_define
class WebSearchRequestWithMode:
    """
    Attributes:
        ...
        mode (Literal['web'] | Unset): Search mode discriminator Default: 'web'.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mode = cast(Literal["web"] | Unset, d.pop("mode", UNSET))
        if mode != "web" and not isinstance(mode, Unset):
            raise ValueError(f"mode must match const 'web', got '{mode}'")

        web_search_request_with_mode = cls(
            query=query,
        ...
        web_search_request_with_mode.additional_properties = d
        return web_search_request_with_mode

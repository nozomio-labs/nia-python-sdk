...
T = TypeVar("T", bound="BootstrapKeyResponse")


@_attrs_define
class BootstrapKeyResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bootstrap_key_response.additional_properties = d
        return bootstrap_key_response

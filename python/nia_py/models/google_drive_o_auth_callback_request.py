...
T = TypeVar("T", bound="GoogleDriveOAuthCallbackRequest")


@_attrs_define
class GoogleDriveOAuthCallbackRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        google_drive_o_auth_callback_request = cls(
            code=code,
            redirect_uri=redirect_uri,
        )

        google_drive_o_auth_callback_request.additional_properties = d
        return google_drive_o_auth_callback_request

...
T = TypeVar("T", bound="GoogleDriveInstallRequest")


@_attrs_define
class GoogleDriveInstallRequest:
    """
    Attributes:
        redirect_uri (None | str | Unset): Optional OAuth redirect URI override. Defaults to the backend callback URL.
        scopes (list[str] | None | Unset): Optional scope override. Defaults to readonly Drive scopes.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        google_drive_install_request = cls(
            redirect_uri=redirect_uri,
            scopes=scopes,
        )

        google_drive_install_request.additional_properties = d
        return google_drive_install_request

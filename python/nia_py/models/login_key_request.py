...
T = TypeVar("T", bound="LoginKeyRequest")


@_attrs_define
class LoginKeyRequest:
    """
    Attributes:
        email (str):
        password (str):
        organization_id (None | str | Unset): Org to scope the new key to (must be a member)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        login_key_request.additional_properties = d
        return login_key_request

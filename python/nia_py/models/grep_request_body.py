...
T = TypeVar("T", bound="GrepRequestBody")


@_attrs_define
class GrepRequestBody:
    """
    Attributes:
        ...
        highlight (bool | Unset):  Default: False.
        include_line_numbers (bool | Unset):  Default: True.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grep_request_body.additional_properties = d
        return grep_request_body

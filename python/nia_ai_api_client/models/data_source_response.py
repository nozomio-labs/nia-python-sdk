...
if TYPE_CHECKING:
    from ..models.data_source_response_document_tree_type_0 import DataSourceResponseDocumentTreeType0
...
class DataSourceResponse:
    ...
    Attributes:
        ...
        has_tree_index (bool | None | Unset):
        document_tree (DataSourceResponseDocumentTreeType0 | None | Unset):
        indexing_job_id (None | str | Unset):
    ...
    has_tree_index: bool | None | Unset = UNSET
    document_tree: DataSourceResponseDocumentTreeType0 | None | Unset = UNSET
    indexing_job_id: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        has_tree_index: bool | None | Unset
        if isinstance(self.has_tree_index, Unset):
            has_tree_index = UNSET
        else:
            has_tree_index = self.has_tree_index

        document_tree: dict[str, Any] | None | Unset
        if isinstance(self.document_tree, Unset):
            document_tree = UNSET
        elif isinstance(self.document_tree, DataSourceResponseDocumentTreeType0):
            document_tree = self.document_tree.to_dict()
        else:
            document_tree = self.document_tree

        indexing_job_id: None | str | Unset
        if isinstance(self.indexing_job_id, Unset):
            indexing_job_id = UNSET
        else:
            indexing_job_id = self.indexing_job_id
        ...
        if has_tree_index is not UNSET:
            field_dict["has_tree_index"] = has_tree_index
        if document_tree is not UNSET:
            field_dict["document_tree"] = document_tree
        if indexing_job_id is not UNSET:
            field_dict["indexing_job_id"] = indexing_job_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_has_tree_index(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        has_tree_index = _parse_has_tree_index(d.pop("has_tree_index", UNSET))

        def _parse_document_tree(data: object) -> DataSourceResponseDocumentTreeType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                document_tree_type_0 = DataSourceResponseDocumentTreeType0.from_dict(data)

                return document_tree_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataSourceResponseDocumentTreeType0 | None | Unset, data)

        document_tree = _parse_document_tree(d.pop("document_tree", UNSET))

        def _parse_indexing_job_id(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        indexing_job_id = _parse_indexing_job_id(d.pop("indexing_job_id", UNSET))

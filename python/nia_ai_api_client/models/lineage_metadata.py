...
T = TypeVar("T", bound="LineageMetadata")
...
class LineageMetadata:
    ...
    Attributes:
        created_at (datetime.datetime): When this artifact was created
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lineage_metadata.additional_properties = d

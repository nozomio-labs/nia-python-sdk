...
def sync_detailed(
    *,
    ...
    """Bulk delete resources
     ...
     Delete multiple resources in a single request. Supports repositories, documentation, research
    papers, contexts, and local folders.

    Args:
        body (BulkDeleteRequest): Request for bulk deletion
...
def sync(
    *,
    ...
    Returns:
        BulkDeleteResponse | HTTPValidationError
    """
